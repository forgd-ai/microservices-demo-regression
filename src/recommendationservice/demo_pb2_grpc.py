...
class CartServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.EmptyCart = channel.unary_unary(
                ...
                response_deserializer=demo__pb2.Empty.FromString,
                _registered_method=True)
        self.GetCartHistory = channel.unary_unary(
                '/hipstershop.CartService/GetCartHistory',
                request_serializer=demo__pb2.GetCartHistoryRequest.SerializeToString,
                response_deserializer=demo__pb2.CartHistory.FromString,
                _registered_method=True)
...
class CartServiceServicer(object):
    ...
    def GetCartHistory(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CartServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetCartHistory': grpc.unary_unary_rpc_method_handler(
                    servicer.GetCartHistory,
                    request_deserializer=demo__pb2.GetCartHistoryRequest.FromString,
                    response_serializer=demo__pb2.CartHistory.SerializeToString,
            ),
    }
...
class CartService(object):
    ...
    def GetCartHistory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.CartService/GetCartHistory',
            demo__pb2.GetCartHistoryRequest.SerializeToString,
            demo__pb2.CartHistory.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class RecommendationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListRecommendations = channel.unary_unary(
                ...
                _registered_method=True)
        self.ListFrequentlyBoughtTogether = channel.unary_unary(
                '/hipstershop.RecommendationService/ListFrequentlyBoughtTogether',
                request_serializer=demo__pb2.FBTRequest.SerializeToString,
                response_deserializer=demo__pb2.FBTResponse.FromString,
                _registered_method=True)
...
def add_RecommendationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListFrequentlyBoughtTogether': grpc.unary_unary_rpc_method_handler(
                    servicer.ListFrequentlyBoughtTogether,
                    request_deserializer=demo__pb2.FBTRequest.FromString,
                    response_serializer=demo__pb2.FBTResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class RecommendationService(object):
    ...
    @staticmethod
    def ListFrequentlyBoughtTogether(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.RecommendationService/ListFrequentlyBoughtTogether',
            demo__pb2.FBTRequest.SerializeToString,
            demo__pb2.FBTResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
