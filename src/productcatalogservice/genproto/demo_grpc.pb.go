...
const (
	...
	CartService_GetCartHistory_FullMethodName = "/hipstershop.CartService/GetCartHistory"
)
...
type CartServiceClient interface {
	...
	GetCartHistory(ctx context.Context, in *GetCartHistoryRequest, opts ...grpc.CallOption) (*CartHistory, error)
}
...
func (c *cartServiceClient) GetCartHistory(ctx context.Context, in *GetCartHistoryRequest, opts ...grpc.CallOption) (*CartHistory, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CartHistory)
...
type CartServiceServer interface {
	...
	GetCartHistory(context.Context, *GetCartHistoryRequest) (*CartHistory, error)
...
func (UnimplementedCartServiceServer) GetCartHistory(context.Context, *GetCartHistoryRequest) (*CartHistory, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCartHistory not implemented")
}
...
const (
	...
	RecommendationService_ListFrequentlyBoughtTogether_FullMethodName = "/hipstershop.RecommendationService/ListFrequentlyBoughtTogether"
)
...
type RecommendationServiceClient interface {
	...
	ListFrequentlyBoughtTogether(ctx context.Context, in *FBTRequest, opts ...grpc.CallOption) (*FBTResponse, error)
}
...
func (c *recommendationServiceClient) ListFrequentlyBoughtTogether(ctx context.Context, in *FBTRequest, opts ...grpc.CallOption) (*FBTResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FBTResponse)
	err := c.cc.Invoke(ctx, RecommendationService_ListFrequentlyBoughtTogether_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RecommendationServiceServer interface {
	...
	ListFrequentlyBoughtTogether(context.Context, *FBTRequest) (*FBTResponse, error)
...
func (UnimplementedRecommendationServiceServer) ListFrequentlyBoughtTogether(context.Context, *FBTRequest) (*FBTResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListFrequentlyBoughtTogether not implemented")
}
...
func _RecommendationService_ListFrequentlyBoughtTogether_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FBTRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendationServiceServer).ListFrequentlyBoughtTogether(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecommendationService_ListFrequentlyBoughtTogether_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).ListFrequentlyBoughtTogether(ctx, req.(*FBTRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RecommendationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListFrequentlyBoughtTogether",
			Handler:    _RecommendationService_ListFrequentlyBoughtTogether_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "demo.proto",
