...
func (x *GetCartHistoryRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *GetCartHistoryRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *CartHistory) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CartHistory) ProtoMessage() {}

func (x *CartHistory) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CartHistory.ProtoReflect.Descriptor instead.
func (*CartHistory) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{6}
}

func (x *CartHistory) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *CartHistory) GetProductIds() []string {
	if x != nil {
		return x.ProductIds
	}
	return nil
...
func (x *FBTRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FBTRequest) ProtoMessage() {}

func (x *FBTRequest) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FBTRequest.ProtoReflect.Descriptor instead.
func (*FBTRequest) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{10}
}

func (x *FBTRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *FBTRequest) GetProductIds() []string {
	if x != nil {
		return x.ProductIds
	}
	return nil
...
func (x *FBTRequest) GetMaxResults() int32 {
	if x != nil {
		return x.MaxResults
	}
	return 0
...
type FBTItem struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	ProductId string                 `protobuf:"bytes,1,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`
	// Number of historical baskets pairing this item with the cart contents.
	CooccurrenceCount int32 `protobuf:"varint,2,opt,name=cooccurrence_count,json=cooccurrenceCount,proto3" json:"cooccurrence_count,omitempty"`
	// Human-readable reason, e.g. "Often bought with Sunglasses".
	Reason        string `protobuf:"bytes,3,opt,name=reason,proto3" json:"reason,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *FBTItem) Reset() {
	*x = FBTItem{}
...
func (x *FBTItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FBTItem) ProtoMessage() {}

func (x *FBTItem) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FBTItem.ProtoReflect.Descriptor instead.
func (*FBTItem) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{11}
}

func (x *FBTItem) GetProductId() string {
	if x != nil {
		return x.ProductId
	}
	return ""
...
func (x *FBTItem) GetCooccurrenceCount() int32 {
	if x != nil {
...
func (x *FBTItem) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
type FBTResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Items         []*FBTItem             `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *FBTResponse) Reset() {
	*x = FBTResponse{}
...
func (x *FBTResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FBTResponse) ProtoMessage() {}

func (x *FBTResponse) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FBTResponse.ProtoReflect.Descriptor instead.
func (*FBTResponse) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{12}
}

func (x *FBTResponse) GetItems() []*FBTItem {
	if x != nil {
		return x.Items
	}
	return nil
...
const file_demo_proto_rawDesc = "" +
	...
	"\x04Cart\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12+\n" +
	"\x05items\x18\x02 \x03(\v2\x15.hipstershop.CartItemR\x05items\"F\n" +
	"\x15GetCartHistoryRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\"G\n" +
	"\vCartHistory\x12\x17\n" +
	...
	"\x12cooccurrence_count\x18\x02 \x01(\x05R\x11cooccurrenceCount\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason\"9\n" +
	"\vFBTResponse\x12*\n" +
	"\x05items\x18\x01 \x03(\v2\x14.hipstershop.FBTItemR\x05items\"\xba\x01\n" +
	"\aProduct\x12\x0e\n" +
	...
	"\x04text\x18\x02 \x01(\tR\x04text2\x9c\x02\n" +
	"\vCartService\x12<\n" +
	...
	"\tEmptyCart\x12\x1d.hipstershop.EmptyCartRequest\x1a\x12.hipstershop.Empty\"\x00\x12P\n" +
	"\x0eGetCartHistory\x12\".hipstershop.GetCartHistoryRequest\x1a\x18.hipstershop.CartHistory\"\x002\xd8\x01\n" +
	"\x15RecommendationService\x12j\n" +
	"\x13ListRecommendations\x12'.hipstershop.ListRecommendationsRequest\x1a(.hipstershop.ListRecommendationsResponse\"\x00\x12S\n" +
	"\x1cListFrequentlyBoughtTogether\x12\x17.hipstershop.FBTRequest\x1a\x18.hipstershop.FBTResponse\"\x002\x83\x02\n" +
...
var file_demo_proto_goTypes = []any{
	...
	(*GetCartHistoryRequest)(nil),          // 5: hipstershop.GetCartHistoryRequest
	(*CartHistory)(nil),                    // 6: hipstershop.CartHistory
	...
	(*FBTRequest)(nil),                     // 10: hipstershop.FBTRequest
	(*FBTItem)(nil),                        // 11: hipstershop.FBTItem
	(*FBTResponse)(nil),                    // 12: hipstershop.FBTResponse
	(*Product)(nil),                        // 13: hipstershop.Product
	(*ListProductsResponse)(nil),           // 14: hipstershop.ListProductsResponse
	(*GetProductRequest)(nil),              // 15: hipstershop.GetProductRequest
	(*SearchProductsRequest)(nil),          // 16: hipstershop.SearchProductsRequest
	(*SearchProductsResponse)(nil),         // 17: hipstershop.SearchProductsResponse
...
var file_demo_proto_depIdxs = []int32{
	...
	11, // 2: hipstershop.FBTResponse.items:type_name -> hipstershop.FBTItem
	23, // 3: hipstershop.Product.price_usd:type_name -> hipstershop.Money
	13, // 4: hipstershop.ListProductsResponse.products:type_name -> hipstershop.Product
	13, // 5: hipstershop.SearchProductsResponse.results:type_name -> hipstershop.Product
	22, // 6: hipstershop.GetQuoteRequest.address:type_name -> hipstershop.Address
	0,  // 7: hipstershop.GetQuoteRequest.items:type_name -> hipstershop.CartItem
	23, // 8: hipstershop.GetQuoteResponse.cost_usd:type_name -> hipstershop.Money
	22, // 9: hipstershop.ShipOrderRequest.address:type_name -> hipstershop.Address
	0,  // 10: hipstershop.ShipOrderRequest.items:type_name -> hipstershop.CartItem
	23, // 11: hipstershop.CurrencyConversionRequest.from:type_name -> hipstershop.Money
	23, // 12: hipstershop.ChargeRequest.amount:type_name -> hipstershop.Money
	26, // 13: hipstershop.ChargeRequest.credit_card:type_name -> hipstershop.CreditCardInfo
	0,  // 14: hipstershop.OrderItem.item:type_name -> hipstershop.CartItem
	23, // 15: hipstershop.OrderItem.cost:type_name -> hipstershop.Money
	23, // 16: hipstershop.OrderResult.shipping_cost:type_name -> hipstershop.Money
	22, // 17: hipstershop.OrderResult.shipping_address:type_name -> hipstershop.Address
	29, // 18: hipstershop.OrderResult.items:type_name -> hipstershop.OrderItem
	30, // 19: hipstershop.SendOrderConfirmationRequest.order:type_name -> hipstershop.OrderResult
	22, // 20: hipstershop.PlaceOrderRequest.address:type_name -> hipstershop.Address
	26, // 21: hipstershop.PlaceOrderRequest.credit_card:type_name -> hipstershop.CreditCardInfo
	30, // 22: hipstershop.PlaceOrderResponse.order:type_name -> hipstershop.OrderResult
	36, // 23: hipstershop.AdResponse.ads:type_name -> hipstershop.Ad
	...
	5,  // 27: hipstershop.CartService.GetCartHistory:input_type -> hipstershop.GetCartHistoryRequest
	8,  // 28: hipstershop.RecommendationService.ListRecommendations:input_type -> hipstershop.ListRecommendationsRequest
	10, // 29: hipstershop.RecommendationService.ListFrequentlyBoughtTogether:input_type -> hipstershop.FBTRequest
	7,  // 30: hipstershop.ProductCatalogService.ListProducts:input_type -> hipstershop.Empty
	15, // 31: hipstershop.ProductCatalogService.GetProduct:input_type -> hipstershop.GetProductRequest
	16, // 32: hipstershop.ProductCatalogService.SearchProducts:input_type -> hipstershop.SearchProductsRequest
	18, // 33: hipstershop.ShippingService.GetQuote:input_type -> hipstershop.GetQuoteRequest
	20, // 34: hipstershop.ShippingService.ShipOrder:input_type -> hipstershop.ShipOrderRequest
	7,  // 35: hipstershop.CurrencyService.GetSupportedCurrencies:input_type -> hipstershop.Empty
	25, // 36: hipstershop.CurrencyService.Convert:input_type -> hipstershop.CurrencyConversionRequest
	27, // 37: hipstershop.PaymentService.Charge:input_type -> hipstershop.ChargeRequest
	31, // 38: hipstershop.EmailService.SendOrderConfirmation:input_type -> hipstershop.SendOrderConfirmationRequest
	32, // 39: hipstershop.CheckoutService.PlaceOrder:input_type -> hipstershop.PlaceOrderRequest
	34, // 40: hipstershop.AdService.GetAds:input_type -> hipstershop.AdRequest
	7,  // 41: hipstershop.CartService.AddItem:output_type -> hipstershop.Empty
	4,  // 42: hipstershop.CartService.GetCart:output_type -> hipstershop.Cart
	7,  // 43: hipstershop.CartService.EmptyCart:output_type -> hipstershop.Empty
	6,  // 44: hipstershop.CartService.GetCartHistory:output_type -> hipstershop.CartHistory
	9,  // 45: hipstershop.RecommendationService.ListRecommendations:output_type -> hipstershop.ListRecommendationsResponse
	12, // 46: hipstershop.RecommendationService.ListFrequentlyBoughtTogether:output_type -> hipstershop.FBTResponse
	14, // 47: hipstershop.ProductCatalogService.ListProducts:output_type -> hipstershop.ListProductsResponse
	13, // 48: hipstershop.ProductCatalogService.GetProduct:output_type -> hipstershop.Product
	17, // 49: hipstershop.ProductCatalogService.SearchProducts:output_type -> hipstershop.SearchProductsResponse
	19, // 50: hipstershop.ShippingService.GetQuote:output_type -> hipstershop.GetQuoteResponse
	21, // 51: hipstershop.ShippingService.ShipOrder:output_type -> hipstershop.ShipOrderResponse
	24, // 52: hipstershop.CurrencyService.GetSupportedCurrencies:output_type -> hipstershop.GetSupportedCurrenciesResponse
	23, // 53: hipstershop.CurrencyService.Convert:output_type -> hipstershop.Money
	28, // 54: hipstershop.PaymentService.Charge:output_type -> hipstershop.ChargeResponse
	7,  // 55: hipstershop.EmailService.SendOrderConfirmation:output_type -> hipstershop.Empty
	33, // 56: hipstershop.CheckoutService.PlaceOrder:output_type -> hipstershop.PlaceOrderResponse
	35, // 57: hipstershop.AdService.GetAds:output_type -> hipstershop.AdResponse
